  ...
  return (
    <>
      <div className="flex flex-col py-10 justify-end items-end">
        <h1 className="text-4xl text-white">Olga Kruhlova</h1>
        <p className="text-sm text-light-blue mb-10">Frontend developer</p>

        <div className="text-md text-white mt-8 flex flex-col justify-end items-end">
          <p className="mb-2">
            I'm a front-end developer based in Poznan, Poland.
          </p>
          <p className="mb-2">
            I'm passionate about pixel-perfect, beautiful interfaces.
          </p>
          <p className="mb-2">
            {yearsAgo} years ago I decided to try myself in frontend. Today it
            is my passion.
          </p>
          <p className="mb-2">
